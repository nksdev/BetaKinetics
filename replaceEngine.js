...
export function calculateDecisionSupportDose(
  ...
  if (category === 'long') {
    ...
    // but if extreme high, some endos allow a slight bump. We'll stick to fixed + 0 correction
  ...
  if (category === 'premixed') {
    ...
    // Base dose for premixed is usually based on TDD. We'll use a conservative default 
    // or if they have prescribedBasalDose, use that as the anchor.
